...
/**
 *
 * Norwegian translation (Bokm氓l: no-NB)
 * By Tore Kj酶rsvik 21-January-2008
 *  
 */
...
if(Ext.DatePicker){
  Ext.apply(Ext.DatePicker.prototype, {
    todayText         : "I dag",
    minText           : "Denne datoen er f酶r tidligste tillatte dato",
    maxText           : "Denne datoen er etter seneste tillatte dato",
    disabledDaysText  : "",
    disabledDatesText : "",
    monthNames	      : Date.monthNames,
    dayNames		      : Date.dayNames,
    nextText          : 'Neste m氓ned (Control+Pil H酶yre)',
    prevText          : 'Forrige m氓ned (Control+Pil Venstre)',
    monthYearText     : 'Velg en m氓ned (Control+Pil Opp/Ned for 氓 skifte 氓r)',
...
if(Ext.form.TextField){
  Ext.apply(Ext.form.TextField.prototype, {
    ...
    maxLengthText : "Den st酶rste lengden for dette feltet er {0}",
    blankText     : "Dette feltet er p氓krevd",
    regexText     : "",
    emptyText     : null
  });
}
...
if(Ext.form.NumberField){
  Ext.apply(Ext.form.NumberField.prototype, {
    ...
    maxText : "Den st酶rste verdien for dette feltet er {0}",
...
if(Ext.form.DateField){
  Ext.apply(Ext.form.DateField.prototype, {
    ...
    minText           : "Datoen i dette feltet m氓 v忙re etter {0}",
    maxText           : "Datoen i dette feltet m氓 v忙re f酶r {0}",
    invalidText       : "{0} er ikke en gyldig dato - den m氓 v忙re p氓 formatet {1}",
    format            : "d.m.y",
...
if(Ext.form.VTypes){
   Ext.apply(Ext.form.VTypes, {
      emailText    : 'Dette feltet skal v忙re en epost adresse p氓 formatet "bruker@domene.no"',
      urlText      : 'Dette feltet skal v忙re en link (URL) p氓 formatet "http:/'+'/www.domene.no"',
...
if(Ext.form.HtmlEditor){
  Ext.apply(Ext.form.HtmlEditor.prototype, {
    ...
    buttonTips : {
      bold : {
        title: 'Fet (Ctrl+B)',
        text: 'Gj酶r den valgte teksten fet.',
        cls: 'x-html-editor-tip'
      },
      italic : {
        title: 'Kursiv (Ctrl+I)',
        text: 'Gj酶r den valgte teksten kursiv.',
        cls: 'x-html-editor-tip'
      },
      underline : {
      ...
      increasefontsize : {
        title: 'Forst酶rr tekst',
        text: 'Gj酶r fontst酶rrelse st酶rre.',
        cls: 'x-html-editor-tip'
      },
      decreasefontsize : {
        title: 'Forminsk tekst',
        text: 'Gj酶r fontst酶rrelse mindre.',
        cls: 'x-html-editor-tip'
      },
      backcolor : {
      ...
      forecolor : {
        title: 'Font farge',
        text: 'Endre farge p氓 den valgte teksten.',
        cls: 'x-html-editor-tip'
      },
      justifyleft : {
      ...
      justifyright : {
        title: 'H酶yrejuster tekst',
        text: 'H酶yrejuster teksten.',
        cls: 'x-html-editor-tip'
      },
      insertunorderedlist : {
        title: 'Punktliste',
      ...
      createlink : {
        title: 'Lenke',
        text: 'Gj酶r den valgte teksten til en lenke.',
        cls: 'x-html-editor-tip'
      },
      sourceedit : {
        title: 'Rediger kilde',
...
if(Ext.layout.BorderLayout && Ext.layout.BorderLayout.SplitRegion){
  Ext.apply(Ext.layout.BorderLayout.SplitRegion.prototype, {
    splitTip            : "Dra for 氓 endre st酶rrelse.",
    collapsibleSplitTip : "Dra for 氓 endre st酶rrelse. Dobbelklikk for 氓 skjule."
  });
}
