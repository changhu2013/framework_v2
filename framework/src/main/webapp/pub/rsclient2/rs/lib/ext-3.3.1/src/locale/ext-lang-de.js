...
Ext.UpdateManager.defaults.indicatorText = '<div class="loading-indicator">脺bertrage Daten ...</div>';
...
if(Ext.grid.GridPanel){
   Ext.grid.GridPanel.prototype.ddText = "{0} Zeile(n) ausgew盲hlt";
}

if(Ext.TabPanelItem){
   Ext.TabPanelItem.prototype.closeText = "Diesen Tab schlie脽en";
}
...
if(Ext.LoadMask){
  Ext.LoadMask.prototype.msg = "脺bertrage Daten...";
}
...
if(Ext.DatePicker){
   Ext.apply(Ext.DatePicker.prototype, {
      todayText         : "Heute",
      minText           : "Dieses Datum liegt von dem erstm枚glichen Datum",
      maxText           : "Dieses Datum liegt nach dem letztm枚glichen Datum",
      disabledDaysText  : "",
      disabledDatesText : "",
      monthNames        : Date.monthNames,
      dayNames          : Date.dayNames,
      nextText          : "N盲chster Monat (Strg/Control + Rechts)",
      prevText          : "Vorheriger Monat (Strg/Control + Links)",
      monthYearText     : "Monat ausw盲hlen (Strg/Control + Hoch/Runter, um ein Jahr auszuw盲hlen)",
...
if(Ext.form.NumberField){
   Ext.apply(Ext.form.NumberField.prototype, {
      minText : "Der Mindestwert f眉r dieses Feld ist {0}",
      maxText : "Der Maximalwert f眉r dieses Feld ist {0}",
...
if(Ext.form.DateField){
   Ext.apply(Ext.form.DateField.prototype, {
      ...
      invalidText       : "{0} ist kein g眉ltiges Datum - es muss im Format {1} eingegeben werden",
      format            : "d.m.Y",
...
if(Ext.form.HtmlEditor){
  Ext.apply(Ext.form.HtmlEditor.prototype, {
    createLinkText : 'Bitte geben Sie die URL f眉r den Link ein:',
    buttonTips : {
      bold : {
        title: 'Fett (Ctrl+B)',
        text: 'Erstellt den ausgew盲hlten Text in Fettschrift.',
        cls: 'x-html-editor-tip'
      },
      italic : {
        title: 'Kursiv (Ctrl+I)',
        text: 'Erstellt den ausgew盲hlten Text in Schr盲gschrift.',
        cls: 'x-html-editor-tip'
      },
      underline : {
        title: 'Unterstrichen (Ctrl+U)',
        text: 'Unterstreicht den ausgew盲hlten Text.',
        cls: 'x-html-editor-tip'
      },
      increasefontsize : {
        title: 'Text verg枚脽ern',
        text: 'Erh枚ht die Schriftgr枚脽e.',
        cls: 'x-html-editor-tip'
      },
      decreasefontsize : {
        title: 'Text verkleinern',
        text: 'Verringert die Schriftgr枚脽e.',
        cls: 'x-html-editor-tip'
      },
      backcolor : {
        title: 'Text farblich hervorheben',
        text: 'Hintergrundfarbe des ausgew盲hlten Textes 盲ndern.',
        cls: 'x-html-editor-tip'
      },
      forecolor : {
        title: 'Schriftfarbe',
        text: 'Farbe des ausgew盲hlten Textes 盲ndern.',
        cls: 'x-html-editor-tip'
      },
      justifyleft : {
        title: 'Linksb眉ndig',
        text: 'Setzt den Text linksb眉ndig.',
        cls: 'x-html-editor-tip'
      },
      justifycenter : {
        title: 'Zentrieren',
      ...
      justifyright : {
        title: 'Rechtsb眉ndig',
        text: 'Setzt den Text rechtsb眉ndig.',
        cls: 'x-html-editor-tip'
      },
      insertunorderedlist : {
        title: 'Aufz盲hlungsliste',
        text: 'Beginnt eine Aufz盲hlungsliste mit Spiegelstrichen.',
        cls: 'x-html-editor-tip'
      },
      insertorderedlist : {
      ...
      createlink : {
        title: 'Hyperlink',
        text: 'Erstellt einen Hyperlink aus dem ausgew盲hlten text.',
        cls: 'x-html-editor-tip'
      },
      sourceedit : {
...
if(Ext.layout.BorderLayout && Ext.layout.BorderLayout.SplitRegion){
  Ext.apply(Ext.layout.BorderLayout.SplitRegion.prototype, {
    splitTip            : "Ziehen, um Gr枚脽e zu 盲ndern.",
    collapsibleSplitTip : "Ziehen, um Gr枚脽e zu 盲ndern. Doppelklick um Panel auszublenden."
  });
}
...
if(Ext.form.TimeField){
   Ext.apply(Ext.form.TimeField.prototype, {
    ...
    invalidText : "{0} ist keine g眉ltige Zeit",
    format : "H:i"
   });
}
...
if(Ext.form.CheckboxGroup){
  Ext.apply(Ext.form.CheckboxGroup.prototype, {
    blankText : "Du mu脽t mehr als einen Eintrag aus der Gruppe ausw盲hlen"
  });
}

if(Ext.form.RadioGroup){
  Ext.apply(Ext.form.RadioGroup.prototype, {
    blankText : "Du mu脽t einen Eintrag aus der Gruppe ausw盲hlen"
  });
}
