 ...
 * @license License Information at <http://www.fusioncharts.com/license> @author
 * FusionCharts
 * 
 * @version 3.2.1-release Third-party attributions: SWFObject v2.2
 *          <http://code.google.com/p/swfobject/> JSON v2
 *          <http://www.JSON.org/js.html> Firebug Lite 1.3.0
 *          <http://getfirebug.com/firebuglite> jQuery 1.4.2
 *          <http://jquery.com/>
 */
(function() {
	...
	f.extend =
			function(a, b) {
				var c =
						typeof arguments[arguments.length - 1] === 'boolean' ? arguments[arguments.length - 1]
							: false;
				var d = b, snk = a;
	...
	f.core =
			function(a) {
				...
				this.id =
						typeof b.id === 'undefined' ? this.id = f.uniqueId()
							: b.id;
				this.args = b;
				if(f.core.items[this.id] instanceof f.core) {
					this.id = f.uniqueId();
					f.raiseWarning(this, '06091847', 'param', '',
						'A FusionChart oject with the specified id \"'
							+ this.id + '\" already exists. Renaming it to '
							+ this.id)
				}
...
(function() {
	...
	f.policies.options.containerElementId = [
			'renderAt',
			undefined ];
	f.policies.options.renderer = [
			'renderer',
			undefined ];
	var g =
			function() {
	...
	f.renderer =
			{
				...
				update : function(a) {
					store[a.id].update.apply(a, Array.prototype.slice.call(
						arguments, 1))
				},
				render : function(a) {
					store[a.id].render.apply(a, Array.prototype.slice.call(
						arguments, 1))
				},
				resize : function(a) {
					store[a.id].resize.apply(a, Array.prototype.slice.call(
						arguments, 1))
				},
				config : function(a) {
					store[a.id].config.apply(a, Array.prototype.slice.call(
						arguments, 1))
				}
			};
	var j =
	...
	var l =
			function(a) {
				...
				f.raiseEvent('internal.DOMElementCreated', a,
					f.core.items[a.id])
			};
	f
			.extend(
				{
					render : function(a) {
						...
						if(k(this.id, a)) {
							f.raiseError(this, '05102109', 'run', '.render()',
								new Error(
...
(function() {
	...
	g.policies.options.dataSource = [
			'dataSource',
			undefined ];
	g.policies.options.dataFormat = [
			'dataFormat',
			undefined ];
	g.addDataHandler =
			function(b, c) {
			...
			.extend(
				{
					setChartDataUrl : function(c, d, e) {
						...
						xStore[this.id] =
								g.ajax.get(decodeURIComponent(c),
									function(a, x) {
										var b = false;
										g.raiseEvent(
					...
					setChartData : function(a, b, c) {
						...
						var e = h[d], parseResult, eventArgs, cancelDUFlag =
								false;
						...
						if(cancelDUFlag === true) {
							g
									.raiseEvent('DataUpdateCancelled',
										eventArgs, this);
							return
						}
						dataStore[this.id] =
								(parseResult.data = eventArgs.data) || '';
						cache[this.id] = {};
						if(c !== true) {
					...
					getChartData : function(a, b) {
						...
						parseResult =
								(typeof cache[this.id][a] === 'object') ? cache[this.id][a]
									: cache[this.id][a] =
											c.decode(dataStore[this.id], this);
	...
	g.extend( { transcodeData : function(a, b, c, d) {
		if(!b || typeof b.toString !== 'function' || !c
			...
			g.raiseError(this, '14090217', 'param', 'transcodeData()',
				new Error(
...
(function() {
	...
	var g =
			/(fusioncharts\.js|fusioncharts\.debug\.js|fusioncharts\.core\.js|fusioncharts\.min\.js|fusioncharts\.packed\.js)(\?.*)?$/i;
	var j = { vled : 'realtimeverticalled'
	};
	f.core.options.scriptBaseUri =
			(function() {
				var a = document.getElementsByTagName('script'), l = a.length, scriptBaseUri =
						'', i;
				for(i = 0; i < l; i += 1) {
	...
	f.extend( {
		...
		resizeTo : function(w, h, a) {
			...
			if(b.height && typeof b.height.toString === 'function') {
				this.height =
						b.height.toString().replace(lengthCleanupRegex, '')
			}
			if(a !== true) {
		...
		chartType : function() {
			var a = this.src.substring(this.src.indexOf('.swf'), 0), file =
					a.substring(a.lastIndexOf('/') + 1).toLowerCase();
			...
			.extend(
				{
					setChartAttribute : function(a) {
						...
						var i = 0, json =
								this.getChartData(FusionChartsDataFormats.JSON), prop, attList =
								json.chart || json.graph || {};
						for(prop in a) {
							i += 1;
...
(function() {
	...
	var z =
			y.swfobject =
					function() {
						var w = "undefined", OBJECT = "object", SHOCKWAVE_FLASH =
								"Shockwave Flash", SHOCKWAVE_FLASH_AX =
								...
								"onreadystatechange", win = window, doc =
								document, nav = navigator, plugin = false, domLoadFnArr =
								[ main ], regObjArr = [], objIdArr = [], listenersArr =
								[], storedAltContent, storedAltContentId, storedCallbackFn, storedCallbackObj, isDomLoaded =
								false, isExpressInstallActive = false, dynamicStylesheet, dynamicStylesheetMedia, autoHideShow =
								true, ua =
								function() {
									var b =
											typeof doc.getElementById != w
												&& typeof doc.getElementsByTagName != w
												&& typeof doc.createElement != w, u =
											nav.userAgent.toLowerCase(), p =
											nav.platform.toLowerCase(), windows =
											p ? /win/.test(p) : /win/.test(u), mac =
											p ? /mac/.test(p) : /mac/.test(u), webkit =
											/webkit/.test(u) ? parseFloat(u
													.replace(
														/^.*webkit\/(\d+(\.\d+)?).*$/,
														"$1"))
												: false, ie = !+"\v1", playerVersion =
											[
													0,
													0,
													0 ], d = null;
						...
						function showExpressInstall(a, b, c, d) {
							...
							if(e) {
								...
								if(typeof a.width == w
									|| (!/%$/.test(a.width) && parseInt(
										a.width, 10) < 310)) {
									a.width = "310"
								}
								if(typeof a.height == w
									|| (!/%$/.test(a.height) && parseInt(
										a.height, 10) < 137)) {
									a.height = "137"
								}
								doc.title =
								...
								var f = ua.ie && ua.win ? "ActiveX" : "PlugIn", fv =
										"MMredirectURL="
											+ win.location.toString().replace(
												/&/g, "%26") + "&MMplayerType="
											+ f + "&MMdoctitle=" + doc.title;
						...
						function hasPlayerVersion(a) {
							...
							return (b[0] > v[0]
								|| (b[0] == v[0] && b[1] > v[1]) || (b[0] == v[0]
								&& b[1] == v[1] && b[2] >= v[2])) ? true
								: false
						}
								...
								if(isExpressInstallActive) {
									...
									if(a && storedAltContent) {
										...
										if(storedAltContentId) {
											setVisibility(storedAltContentId,
												true);
											if(ua.ie && ua.win) {
	...
	y.core.options.installRedirectMessage =
	...
	var D =
			function(e, a) {
				...
				if(b.ref && typeof b.ref.dataInvokedOnSWF === 'function'
					...
					b.setChartData(window.unescape(e.sender.ref
							.getXML( { escaped : true
							})), FusionChartsDataFormats.XML, true);
					b.flashVars.dataXML =
							b.getChartData(FusionChartsDataFormats.XML);
					delete b.flashVars.dataURL
				}
				e.sender.removeEventListener('DataLoaded', D)
			};
	window.__fusioncharts_dimension =
			(function() {
				var c = /.*?\%\s*?$/g;
				return function(a) {
					var b, parent;
					return !((b = y.core(a)) instanceof y.core && b.ref && (parent =
							b.ref.parentNode)) ? {} : {
	...
	window.__fusioncharts_vars =
			function(a, b) {
				var c = y.core.items[a];
				if(!(c instanceof y.core)) {
					y
							.raiseError(y.core, '25081621', 'run',
								'::FlashRenderer',
	...
	var E =
			{
				...
				render : function(a, b) {
					...
					var c = {}, dataXML = this.flashVars.dataXML, dataURL =
							this.flashVars.dataURL;
					...
					c.dataURL = C(dataURL || '');
					y.swfobject.embedSWF(this.src, this.id, this.width,
						this.height, '8.0.0', undefined, c, this.params,
						this.attributes, b)
				},
				update : function(a) {
					...
					if(a.error === undefined) {
						...
						if(this.isActive()
							&& typeof b.showChartMessage === 'function') {
							b.showChartMessage('InvalidXMLText')
						} else {
							this.flashVars.dataXML =
									'<Invalid' + a.format.toUpperCase() + '>';
							delete this.flashVars.dataURL;
							delete this.flashVars.animation
						}
					}
				...
				resize : function() {
					...
					if(this.ref !== undefined) {
						...
						if(typeof this.ref.resize === 'function') {
							this.ref.resize(this.ref.offsetWidth,
	...
	E.prototype =
			{
				getSWFHTML : function() {
					var a = document.createElement('span'), inElm =
							document.createElement('span'), tempId =
							'RnVzaW9uQ2hhcnRz' + (new Date()).getTime();
					a.appendChild(inElm);
					inElm.setAttribute('id', tempId);
					a.style.display = 'none';
					document.getElementsByTagName('body')[0].appendChild(a);
					y.swfobject.embedSWF(this.src, tempId, this.width,
						this.height, '8.0.0', undefined, this.flashVars,
				...
				setTransparent : function(a) {
					...
					this.params.wMode =
							a === null ? 'window' : (a === true ? 'transparent'
								: 'opaque')
				},
...
(function() {
	var M, FCC = {}, baseURL = 'JSClass/', covertToFCC, renderArray = [], FCCready =
			false, i, scriptTags, jsConf = {};
	M = FusionCharts( [
			'private',
			'Canvas_Renderer' ]);
	if(M === undefined) {
			...
			function() {
				...
				}, FCFCC =
						{
							...
							method : {
								...
								exportChart : function(a) {
									var b = this.id, HCConf = {}, HCObj =
											FCC.items[b].FCCObj.FCC;
				...
				var o =
						function(a, b, c, d, e, f) {
							...
							minPowerOfTen =
									Math.floor(Math.log(Math.abs(b))
										/ Math.LN10);
							powerOfTen = Math.max(minPowerOfTen, g);
							y_interval = Math.pow(10, powerOfTen);
							if(Math.abs(a) / y_interval < 2
								&& Math.abs(b) / y_interval < 2) {
								powerOfTen -= 1;
								y_interval = Math.pow(10, powerOfTen)
							}
							rangePowerOfTen =
							...
							if(((a - b) > 0)
								&& ((y_interval / rangeInterval) >= 10)) {
								y_interval = rangeInterval;
								powerOfTen = rangePowerOfTen
							}
							y_topBound =
									(Math.floor(a / y_interval) + 1)
										* y_interval;
							if(b < 0) {
								y_lowerBound =
										-1
											* ((Math.floor(Math.abs(b
												/ y_interval)) + 1) * y_interval)
							} else {
								if(f) {
									y_lowerBound = 0
								} else {
							...
							if(yMaxGiven === false
								|| (yMaxGiven === true && Number(c) < a)) {
								yMax = y_topBound
							} else {
								yMax = Number(c)
							}
							if(yMinGiven === false
								|| (yMinGiven === true && Number(d) > b)) {
								yMin = y_lowerBound
							} else {
								yMin = Number(d)
							}
				...
				function createContainer(a, b, c, d, e) {
					var f = document.getElementById(b), __container =
							document.getElementById(a), lengthPercentageRegExp =
							/\%\s*?$/ig;
					if(e === true) {
						if(f) {
					...
					f.style.width =
							c + (c.match(lengthPercentageRegExp) ? '' : 'px');
					f.style.height =
							d + (d.match(lengthPercentageRegExp) ? '' : 'px')
				}
				...
				function createMsg(a, b, c) {
					...
					d.title.y =
							parseInt(document.getElementById(a).offsetHeight,
								10) / 2;
					d.chart.renderTo = a;
				...
				function showChartMessage(a) {
					...
					var c = M.extend( { show : true
					}, this.FusionCharts.link.parent.options.overlayButton);
					M.extend(c, this.FusionCharts.link.parent.link
				...
				function drawOverlayButton(b) {
					if(b.show) {
						...
						c.style.border =
								'1px solid #' + (b.borderColor ? b.borderColor
									: "7f8975");
						c.style.backgroundColor =
								'#' + (b.bgColor ? b.bgColor : "edefec");
						c.style.fontFamily = b.font ? b.font : "Verdana";
						c.style.color =
								'#' + b.fontColor ? b.fontColor : "49563a";
						c.style.fontSize =
								(b.fontSize ? b.fontSize : '10') + 'px';
						c.style.padding = (b.padding ? b.padding : '3') + 'px';
						c.style.fontWeight =
								parseInt(b.bold, 10) === 0 ? 'normal' : 'bold';
						...
						c.onclick =
								(function(a) {
									return function() {
										M.raiseEvent('OverlayButtonClick', {},
											a.FusionCharts)
									}
								}(this));
						document.getElementById(this.id).childNodes[0]
								.appendChild(c)
					}
				}
				...
				function convertColor(a, b, c) {
					...
					if(c && c.match(/^rgba/ig)) {
						...
						if(!b) {
							b =
									parseInt(tempArr[3].slice(0, tempArr[3]
											.indexOf(')')), 10) * 100
						}
					}
					if(a) {
						...
						switch (colorStr.length) {
							case 3 :
								colorStr =
										colorStr[0] + colorStr[0] + colorStr[1]
											+ colorStr[1] + colorStr[2]
											+ colorStr[2];
							break;
							case 6 :
							break;
				...
				var t =
						function(a) {
							...
							if(a instanceof Array) {
								...
								for(x = 0; x < a.length; x += 1) {
									psum += a[x].y;
									pareto.data.push( { y : Math
											.round((psum / sum) * 10000) / 100
									})
								}
							}
							return pareto
				...
				var v =
						function(a, b, d) {
							...
							var f, numberScaleUnit, result, i, res, power, formatedNum =
									'', c = 0, initialVal, decimalVal, splitVal, decimalLength, last;
							for(i in b) {
								e[i.toLowerCase()] = b[i]
							}
							a =
									e.indecimalseparator !== '' ? a.toString()
											.replace(e.indecimalseparator, '.')
										: a;
							a =
									e.inthousandseparator !== '' ? a.toString()
											.replace(e.inthousandseparator, '')
										: a;
							if(d !== 1) {
							...
							if(e.formatnumber == 1) {
								...
								result =
										(splitVal === undefined)
											|| (decimalVal === 0) ? formatedNum
											: formatedNum + decimalVal
							}
							if(e.formatnumberscale == 1) {
								res = a;
								for(i = 0; i < f.length && res / f[i] >= 1; i +=
										1) {
									res = res / f[i]
								}
								i -= 1;
								...
								result =
										(i === -1) ? Math.round(res * power)
											/ power : Math.round(res * power)
											/ power
							}
							if(e.forcedecimals == 1) {
								if(result.toString()
										.indexOf(e.decimalseparator) !== -1) {
									decimalVal =
											result.toString().split(
												e.decimalseparator)[1];
								...
								if(decimalLength > e.decimals) {
									if(e.decimals == 1 && decimalVal[0] >= 5) {
										...
										last =
												decimalVal[e.decimals] >= 5 ? (parseInt(
													decimalVal[e.decimals - 1],
													10) + 1)
													: decimalVal[e.decimals - 1];
										decimalVal =
												decimalVal.substring(0,
													e.decimals - 1)
													+ last;
										result =
												result.substring(0, result
				...
				var F =
						function(a, b) {
							var c = this.width, height = this.height, chart =
									u(this.src), id = this.id, jsonObj, container, dataComp, HCJson;
							removeChart(id, b);
							createContainer.call(this, a, id, c, height, b);
							dataComp =
									this.getChartData(
										FusionChartsDataFormats.JSON, true);
							jsonObj = dataComp.data;
							if(!FCFCC.highCharts[chart]) {
								HCJson =
										createMsg(id, 'ChartNotSupported',
											'featurenotsupported')
							} else if(n[id].msgTxt) {
								HCJson = createMsg(id, 'msgTxt', undefined)
							} else if(this.jsVars && this.jsVars.LoadError) {
								HCJson =
										createMsg(id, 'LoadDataErrorText',
											undefined)
							} else if(this.jsVars && this.jsVars.stallLoad) {
								HCJson =
										createMsg(id, 'XMLLoadingText',
											undefined)
							} else if(dataComp.error instanceof Error) {
								HCJson =
										createMsg(id, 'InvalidXMLText',
											'nodatatodisplay')
							} else {
								container = document.getElementById(id);
								HCJson =
										covertToFCC(id, chart, jsonObj, id,
											container.offsetWidth,
											container.offsetHeight);
								if(HCJson.series.length === 0) {
									HCJson =
											createMsg(id, 'NoDataText',
												'nodatatodisplay')
								}
							}
							return HCJson
				...
				var H =
						function(a, b) {
							...
							var c =
									FCFCC.method.getExternalInterfaceMethods(
										b.chartType()).split(','), i;
						...
						function(c, d) {
							...
							c.timeChach =
									setTimeout(
										(function(b) {
											return function() {
												var a = b.id, __containerId =
														b.options.containerElementId, HCJson;
												if(typeof __containerId !== 'undefined'
													&& typeof FCC.items[a] !== 'undefined') {
													HCJson =
															F.call(b,
																__containerId);
													HCJson.chart.events.load =
															function() {
																M.raiseEvent(
																	'loaded',
																	{}, b);
													...
													HCJson.plotOptions.series.animation =
															false;
													createChart.call(b,
														undefined, HCJson)
												}
											...
											formatter : function() {
												...
												if(this.series.type == 'pie') {
													...
													if(this.point.options.displayvalue) {
														x =
																this.point.options.displayvalue
													} else {
														x =
																v(this.y,
																	a.chart, 1);
									...
									formatter : function() {
										...
										if(this.point.options.tooltext) {
											...
											if(this.series.options.FCtype == 1.5
												...
												x =
														(this.point.FCname ? this.point.FCname
															+ charSep
															: '')
															+ (Math
																	.round(this.percentage * 100) / 100)
				...
				function addPoint(a, b, c, d, e, f, g, h, i) {
					var x, y, isAbs = FCFCC.valueAbs[d], value, seriesType =
							a.type || f.chart.defaultSeriesType, dataseperator, tempY, dataYmax, dataYmin, loopMax;
					if(!a.yAxis) {
						dataYmax = 'dataY0max';
						dataYmin = 'dataY0min'
					} else {
						...
						for(y = 0; y < loopMax; y += 1) {
							if(typeof b[y] === 'object') {
								if(!b[y].vline) {
									...
									addVline(f, b[y].color, b[y].alpha,
										b[y].thickness, y - 0.5)
								}
						...
						for(x = 0; x < a.categories[0].category.length; x += 1) {
							if(typeof a.categories[0].category[x] === 'object') {
								if(!a.categories[0].category[x].vline) {
									...
									addVline(c,
										a.categories[0].category[x].color,
								...
								dataseperator =
										a.chart.dataseparator ? a.chart.dataseparator
											: '|';
								if(b == 2.5) {
									zoomCat =
											zoomCat
				...
				function MSStacked(b, c, d, e, f, g, h, i) {
					var x, y, z, newSeries, count_set = 0, max_cat = 0, a = [], plotWidth =
							f - (e.chart.margin[1] + e.chart.margin[3]), plotHight =
							g - (e.chart.margin[0] + e.chart.margin[2]), noStack, pointWidth, catWidth, tempheight, maxHight =
							0, pointValue = 0;
					if(b.categories && b.categories[0]
					...
					if(b.dataset && b.dataset instanceof Array) {
						...
						for(x = 0; x < b.dataset.length; x += 1) {
							...
							if(b.dataset[x].dataset
								...
								for(y = 0; y < b.dataset[x].dataset.length; y +=
										1) {
									newSeries =
											{
												FCtype : c,
										...
										for(z = 0; z < max_cat; z += 1) {
											tempheight[z] =
													tempheight[z] ? tempheight[z]
														: 0;
											pointValue =
													(b.dataset[x].dataset[y].data[z] && b.dataset[x].dataset[y].data[z].value) ? parseFloat(b.dataset[x].dataset[y].data[z].value)
														: '';
											tempheight[z] +=
				...
				function addData(c, d, e, f, g, h, i) {
					...
					getScolor =
							function(a) {
								var b;
								b =
										(c.chart.palettecolors) ? ((typeof c.chart.palettecolors === 'string') ? c.chart.palettecolors
												.split(',')
							...
							switch (d) {
								...
								case 3 :
									if(c.chart.stack100percent == '1') {
										f.plotOptions.series.stacking =
												'percent';
										f.yAxis[0].labels.formatter =
												function() {
													return parseStr(this.value + '%')
												}
									} else {
								...
								break;
								case 5.5 :
									f.plotOptions.column.stacking =
											c.chart.stack100percent == '1' ? 'percent'
												: 'normal'
							}
							addCategory(c, d, f);
							if(d !== 6) {
								if(c.dataset) {
									...
									for(x = 0; x < c.dataset.length; x += 1) {
										...
										count_set += 1;
										if(c.dataset[x].data) {
											addPoint(z, c.dataset[x].data, d,
												e, i, f, undefined, undefined,
												c)
										}
										a.push(z)
									}
						...
						case 7.5 :
							...
							if(c.dataset) {
								...
								for(x = 0; x < c.dataset.length; x += 1) {
									...
									count_set += 1;
									if(c.dataset[x].data) {
										addPoint(z, c.dataset[x].data, d, e, i,
											f, getScolor, l)
									}
									a.push(z)
								}
							...
							f.xAxis.max =
									c.chart.xaxismaxvalue ? parseInt(
										c.chart.xaxismaxvalue, 10) : undefined;
							f.xAxis.min =
									c.chart.xaxisminvalue ? parseInt(
					...
					if(!((d === 3 || d === 5.5) && c.chart.stack100percent === '1')
						...
						if(d === 1.5 || d === 5.5 || d === 5 || d === 6.5) {
							yCalTemp =
									o(f.FCconf.dataY0max, f.FCconf.dataY0min,
										c.chart.pyaxismaxvalue,
										c.chart.pyaxisminvalue, '',
										c.chart.setadaptiveymin !== '1');
							f.yAxis[0].max = yCalTemp.Max;
							f.yAxis[0].min = yCalTemp.Min;
							if(d !== 1.5) {
								yCalTemp =
										o(f.FCconf.dataY1max,
											f.FCconf.dataY1min,
											c.chart.syaxismaxvalue,
											c.chart.syaxisminvalue, '',
							...
							yCalTemp =
									o(f.FCconf.dataY0max, f.FCconf.dataY0min,
										c.chart.yaxismaxvalue,
										c.chart.yaxisminvalue, '',
										c.chart.setadaptiveymin !== '1');
							f.yAxis[0].max = yCalTemp.Max;
							f.yAxis[0].min = yCalTemp.Min
						}
				...
				function ModyfyLegend(b, c) {
					...
					if(c.chart.showlegend == '0') {
						...
						if(c.chart.interactivelegend == '0') {
							b.plotOptions.series.events.legendItemClick =
									function(a) {
										return false
									};
						...
						b.legend.shadow =
								c.chart.legendshadow == '0' ? false : true;
						b.legend.backgroundColor =
								convertColor(
									c.chart.legendbgcolor || '#ffffff',
									c.chart.legendbgalpha || 100);
						b.legend.borderColor =
								convertColor(
									c.chart.legendbordercolor || '#545454',
									c.chart.legendborderalpha || 100);
						b.legend.borderWidth =
								c.chart.legendborderthickness || 1;
				...
				function convertMarimeko(a, b, c, d, e) {
					var f = c - (a.chart.margin[1] + a.chart.margin[3]), plotHight =
							d - (a.chart.margin[0] + a.chart.margin[2]), y, z, arr =
							[], total = 0, temp, setPersent = false, catCountFlag =
							true, temp2, totalpercent = 0;
					...
					if(e && e[0] && e[0].category instanceof Array) {
						...
						for(y = 0; y < e[0].category.length; y += 1) {
							if(e[0].category[y].widthpercent) {
								temp +=
										parseFloat(e[0].category[y].widthpercent)
							} else {
								break
							}
						}
						if(y === e[0].category.length
							&& Math.round(temp) === 100) {
							setPersent = true
						}
					}
						...
						for(z = 0; z < a.series[y].data.length; z += 1) {
							...
							if(catCountFlag) {
								if(a.xAxis.labels.enabled !== false) {
									a.labels.items
											.push(createText(
												a.xAxis.categories[z],
												plotHight, temp))
								}
								if(b.chart.showsum != '0') {
									a.labels.items.push(createText(v(arr[z],
										b.chart), '-14', temp))
								}
							}
							temp2 =
									setPersent ? parseFloat(e[0].category[z].widthpercent) / 100
										: (arr[z] / total);
							totalpercent += temp2;
							temp +=
									a.series[y].data[z].MWidth =
											Math.round(f * temp2);
							if(catCountFlag
								&& b.chart.showxaxispercentvalues != '0'
								&& totalpercent < 0.9) {
								a.labels.items
										.push(createText(
											(Math.round(totalpercent * 10000) / 100) + '%',
				...
				function covertToFCC(a, b, c, d, e, f) {
					var g, y = getSeriesName(b), x, z, l, j, styleName, tempstyle =
							{}, styleArr;
					...
					g.plotOptions.series.animation =
							c.chart.animation === '0' ? false : true;
					...
					g.xAxis.labels.style =
							{
								fontFamily : c.chart.outcnvbasefont
									|| c.chart.basefont || 'Verdana',
					...
					if(c.chart.drawanchors == '0') {
						g.plotOptions.area.marker.enabled =
								g.plotOptions.line.marker.enabled =
										g.plotOptions.areaspline.marker.enabled =
												g.plotOptions.spline.marker.enabled =
														false;
						g.tooltip.enabled = false
					}
					if(c.chart.anchorradius) {
						g.plotOptions.area.marker.radius =
								g.plotOptions.line.marker.radius =
										g.plotOptions.areaspline.marker.radius =
												g.plotOptions.spline.marker.radius =
														c.chart.anchorradius
					}
					g.plotOptions.line.marker.lineColor =
							g.plotOptions.areaspline.marker.lineColor =
									g.plotOptions.spline.marker.lineColor =
											convertColor(
												c.chart.anchorbordercolor || '767575',
												c.chart.anchoralpha || 100);
					g.plotOptions.area.marker.lineColor =
							convertColor(c.chart.anchorbordercolor || '767575',
								c.chart.anchoralpha || 0);
					if(c.chart.anchorborderthickness) {
						g.plotOptions.area.marker.lineWidth =
								g.plotOptions.line.marker.lineWidth =
										g.plotOptions.areaspline.marker.lineWidth =
												g.plotOptions.spline.marker.lineWidth =
														c.chart.anchorborderthickness
					}
					g.plotOptions.line.marker.fillColor =
							g.plotOptions.spline.marker.fillColor =
									convertColor(
										c.chart.anchorbgcolor || 'FFFFFF',
										c.chart.anchorbgalpha || 100);
					g.plotOptions.area.marker.fillColor =
							g.plotOptions.areaspline.marker.fillColor =
									convertColor(
										c.chart.anchorbgcolor || 'FFFFFF',
										c.chart.anchorbgalpha || 0);
					if(c.chart.anchorsides) {
						g.plotOptions.area.marker.symbol =
								g.plotOptions.line.marker.symbol =
										g.plotOptions.areaspline.marker.symbol =
												g.plotOptions.spline.marker.symbol =
														w(parseInt(
															c.chart.anchorsides,
															10))
					}
					g.plotOptions.line.lineWidth =
							g.plotOptions.spline.lineWidth =
									parseInt(c.chart.linethickness, 10)
										|| (y === 1.5 ? 2 : 3);
					g.plotOptions.line.color =
							g.plotOptions.spline.color =
									convertColor(c.chart.linecolor || '767575',
										c.chart.linealpha || 100);
					g.plotOptions.area.color =
							g.plotOptions.areaspline.color =
									convertColor(
										c.chart.plotfillcolor || '767575',
										c.chart.plotfillalpha || 90);
					g.plotOptions.area.lineColor =
							g.plotOptions.areaspline.lineColor =
									convertColor(c.chart.plotbordercolor
										|| "333333",
										c.chart.plotborderalpha || 95);
					g.plotOptions.area.lineWidth =
							g.plotOptions.areaspline.lineWidth =
									parseInt(c.chart.plotborderthickness, 10) || 1;
					g.yAxis[0].alternateGridColor =
							convertColor(
								c.chart.alternatehgridcolor || 'EEEEEE',
								c.chart.alternatehgridalpha || 50);
					g.yAxis[0].gridLineColor =
							convertColor(c.chart.divlinecolor || '717170',
								c.chart.divlinealpha || 40);
					g.yAxis[0].gridLineWidth =
							c.chart.divlinethickness ? c.chart.divlinethickness
								: 1;
					if(c.chart.caption) {
					...
					if(y == 5 || y == 5.5 || y == 1.5) {
						if(c.chart.pyaxisname) {
							g.yAxis[0].title.text =
									parseStr(c.chart.pyaxisname);
							...
							g.yAxis[0].title.style =
									{
										...
										'font-weight' : 'bold',
										color : c.chart.outcnvbasefontcolor
											|| c.chart.basefontcolor
											|| '#555555'
									}
						}
						if(c.chart.syaxisname) {
							g.yAxis[1].title.text =
									parseStr(c.chart.syaxisname);
					...
					if(c.vtrendlines) {
						for(x = 0; x < c.vtrendlines.length; x += 1) {
							if(c.vtrendlines[x].line) {
								for(z = 0; z < c.vtrendlines[x].line.length; z +=
										1) {
					...
					g.exporting.enabled =
							c.chart.exportenabled == '1' ? true : false;
					g.exporting.buttons.exportButton.enabled =
							c.chart.exportshowmenuitem == '0' ? false : true;
					g.exporting.filename =
							c.chart.exportfilename ? c.chart.exportfilename
								: 'FusionCharts';
					g.exporting.width = e;
					if(c.styles && c.styles.definition instanceof Array
						...
						for(j = 0; j < c.styles.definition.length; j += 1) {
							if(typeof FCFCC.supportedStyle[c.styles.definition[j].type] === 'function') {
								tempstyle[c.styles.definition[j].name
										.toLowerCase()] =
										c.styles.definition[j]
							}
						}
						for(j = 0; j < c.styles.application.length; j += 1) {
							styleArr =
									c.styles.application[j].styles.split(',');
							for(l = 0; l < styleArr.length; l += 1) {
								styleName = styleArr[l].toLowerCase();
								if(tempstyle[styleName]) {
									FCFCC.supportedStyle[tempstyle[styleName].type]
											(
												g,
					...
					g.chart.borderWidth =
							c.chart.showborder == '0' ? 0
								: (c.chart.borderthickness ? c.chart.borderthickness
									: 1);
					g.chart.borderColor =
							convertColor(c.chart.bordercolor || '767575',
								c.chart.borderalpha || 50);
					g.chart.plotBorderColor =
							convertColor(c.chart.canvasbordercolor || '545454',
								c.chart.canvasborderalpha || 100);
					g.chart.plotBorderWidth =
							c.chart.canvasborderthickness ? c.chart.canvasborderthickness
								: 2;
					g.plotOptions.series.borderColor =
							convertColor(c.chart.plotbordercolor || '333333',
								c.chart.plotborderalpha || 95);
					g.plotOptions.series.borderWidth =
							c.chart.showplotborder == '0' ? 0
								: (c.chart.plotborderthickness ? c.chart.plotborderthickness
									: 1);
					g.plotOptions.series.borderRadius =
							c.chart.useroundedges == '1' ? 5 : 0;
					g.yAxis[0].plotLines.push( {
						color : convertColor(
							c.chart.zeroplanecolor || '717170',
					...
					g.chart.backgroundColor =
							r(0, 0, e, f ? f : 400,
								c.chart.bgangle !== undefined ? c.chart.bgangle
									: 270, c.chart.bgcolor ? c.chart.bgcolor
									: "CBCBCB,E9E9E9",
					...
					g.chart.plotBackgroundColor =
							(s(b) == 'pie') ? 'rgba(255,255,255,0)'
								: (r(
									h,
									plotY,
				...
				FCC.update =
						function(b, c) {
							var d = this.id, __containerId =
									this.options.containerElementId, sender =
									this, HCJson, events = {
								dataloaded : 'FC_DataLoaded',
								drawcomplete : 'FC_DrawComplete'
							};
	...
	M
			.extend( { '_fallbackJSChartWhenNoFlash' : function() {
				if(!M.swfobject
				...
				function(c, d) {
					...
					if(/^[\],:{}\s]*$/
							.test(c
									...
									.replace(/(?:^|:|,)(?:\s*\[)+/g, ''))) {
						j = eval('(' + c + ')');
						return typeof d === 'function' ? walk( { '' : j
						}, '') : j
					}
...
(function() {
								...
								for(i = 0; i < b.length; i += 1) {
									...
									if(b[i].nodeType === f) {
										...
										if(b[i].childNodes.length) {
											if(e.group[c]
												&& e.group[c][nodeName]) {
												g.child(a, b[i].childNodes,
													nodeName, d)
											} else {
												g.child(childObj,
													b[i].childNodes, nodeName,
													d)
											}
										}
									...
									} else if(b[i].nodeType === XML_TEXTNODE
										&& d.chart
				...
				var h =
						function(a) {
							...
							if(a === undefined || a === null
								|| typeof a.toString !== 'function') {
								h.errorObject =
										new TypeError('xml2json.parse()');
								return b
							}
							a =
									a.toString().replace(/<\!--[\s\S]*?-->/g,
										'').replace(/<\?xml[\s\S]*?\?>/ig, '')
											.replace(/&(?!([^;\n\r]+?;))/g,
												'&amp;$1');
							a = fastTrim(a);
	...
	var m =
			(function() {
				...
				var f =
						function(a, b) {
							var c = '', innerXML = '', nodeName = '', outerXML =
									'', item, qualifier;
							if(a instanceof Array) {
...
(function() {
	...
	f.extend( { configureLink : function(a, b) {
		if(a instanceof Array) {
			...
			f.raiseError(this, '25081731', 'param', '~configureLink()',
	...
	f
			.addEventListener(
				...
				function(a, b) {
					...
					f.raiseEvent('BeforeLinkedItemOpen', { level : c.link.level
					}, c.link.root);
	...
	f.addEventListener('OverlayButtonClick', function(a) {
		...
		b.dispose();
		f.raiseEvent('LinkedItemClosed', { level : level
		}, b.link.root);
		if(!parent.isActive()
...
(function() {
	...
	var l =
			{
				getCanvasElementOf : function(a, b, c) {
					if(a.__fusioncharts__canvascreated !== true) {
						var d = document.createElement('canvas'), identifier =
								j.core.items[a.id].attributes['class'];
					...
					a.nextSibling
							.setAttribute('width', b || a.offsetWidth || 2);
					a.nextSibling.setAttribute('height', c || a.offsetHeight
						|| 2);
					return a.nextSibling
				},
				removeCanvasElementOf : function(a) {
					if(a.__fusioncharts__canvascreated !== true
						|| !a.parentNode || a.parentNode === null) {
						return
					}
	...
	var n =
			function(a) {
				...
				if(b === undefined
					|| typeof b.prepareImageDataStream !== 'function'
			...
			function(a, b) {
				try {
					if(l.drawRLE(l.getCanvasElementOf(a.sender.ref, b.width,
						b.height), b.stream, b.width, b.height, b.bgColor) === true) {
						if(activeItems[a.sender.id]) {
				...
				{ printManager : {
					...
					enabled : function(a) {
						...
						if('\v' === 'v'
							...
							j
									.raiseWarning(j.core, '25081816', 'run',
