...
if(Ext.grid.GridPanel){
   Ext.grid.GridPanel.prototype.ddText = "{0} ligne(s) s茅lectionn茅(s)";
}
...
if(Ext.DatePicker){
   Ext.apply(Ext.DatePicker.prototype, {
      ...
      nextText          : 'Prochain mois (CTRL+Fl茅che droite)',
      prevText          : 'Mois pr茅c茅dent (CTRL+Fl茅che gauche)',
      monthYearText     : 'Choissisez un mois (CTRL+Fl茅che haut ou bas pour changer d\'ann茅e.)',
...
if(Ext.form.TextField){
   Ext.apply(Ext.form.TextField.prototype, {
      minLengthText : "La longueur minimum de ce champ est de {0} caract猫res",
      maxLengthText : "La longueur maximum de ce champ est de {0} caract猫res",
...
if(Ext.form.DateField){
   Ext.apply(Ext.form.DateField.prototype, {
      ...
      minText           : "La date de ce champ doit 锚tre avant le {0}",
      maxText           : "La date de ce champ doit 锚tre apr猫s le {0}",
      invalidText       : "{0} n'est pas une date valide - il doit 锚tre au format suivant: {1}",
      format            : "d/m/y"
   });
}
...
if(Ext.form.VTypes){
   Ext.apply(Ext.form.VTypes, {
      emailText    : 'Ce champ doit contenir un courriel et doit 锚tre sous ce format: "usager@example.com"',
...
if(Ext.grid.GridView){
   Ext.apply(Ext.grid.GridView.prototype, {
      ...
      lockText     : "Verrouill茅 la colonne",
      unlockText   : "D茅verrouill茅 la colonne",
