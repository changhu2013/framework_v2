...
if(Ext.DatePicker){
  Ext.apply(Ext.DatePicker.prototype, {
    todayText         : "I dag",
    minText           : "Denne datoen er f酶r tidlegaste tillatne dato",
    maxText           : "Denne datoen er etter seinaste tillatne dato",
    disabledDaysText  : "",
    disabledDatesText : "",
    monthNames	      : Date.monthNames,
    dayNames		      : Date.dayNames,
    nextText          : 'Neste m氓nad (Control+Pil H酶gre)',
    prevText          : 'F酶rre m氓nad (Control+Pil Venstre)',
    monthYearText     : 'Velj ein m氓nad (Control+Pil Opp/Ned for 氓 skifte 氓r)',
...
if(Ext.form.TextField){
  Ext.apply(Ext.form.TextField.prototype, {
    ...
    maxLengthText : "Den st酶rste lengda for dette feltet er {0}",
    blankText     : "Dette feltet er p氓kravd",
    regexText     : "",
    emptyText     : null
  });
}
...
if(Ext.form.DateField){
  Ext.apply(Ext.form.DateField.prototype, {
    ...
    minText           : "Datoen i dette feltet m氓 vere etter {0}",
    maxText           : "Datoen i dette feltet m氓 vere f酶r {0}",
    invalidText       : "{0} er ikkje ein gyldig dato - han m氓 vere p氓 formatet {1}",
    format            : "d.m.y",
...
if(Ext.form.VTypes){
   Ext.apply(Ext.form.VTypes, {
      emailText    : 'Dette feltet skal vere ei epost adresse p氓 formatet "bruker@domene.no"',
      urlText      : 'Dette feltet skal vere ein link (URL) p氓 formatet "http:/'+'/www.domene.no"',
...
if(Ext.form.HtmlEditor){
  Ext.apply(Ext.form.HtmlEditor.prototype, {
    ...
    buttonTips : {
      ...
      forecolor : {
        title: 'Font farge',
        text: 'Endre farge p氓 den valde teksten.',
        cls: 'x-html-editor-tip'
      },
      justifyleft : {
      ...
      justifyright : {
        title: 'H酶grejuster tekst',
        text: 'H酶grejuster teksten.',
        cls: 'x-html-editor-tip'
      },
      insertunorderedlist : {
        title: 'Punktliste',
...
if(Ext.layout.BorderLayout && Ext.layout.BorderLayout.SplitRegion){
  Ext.apply(Ext.layout.BorderLayout.SplitRegion.prototype, {
    splitTip            : "Dra for 氓 endre storleik.",
    collapsibleSplitTip : "Dra for 氓 endre storleik. Dobbelklikk for 氓 skjule."
  });
}
